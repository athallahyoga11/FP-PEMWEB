<template>
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1">
                  <form class="submit" @submit.prevent>
                    <input
                      ...
                      placeholder="blabla.com" required />
                    <br>
                    <input
                      class="w-full focus:border-blue-600 focus:ring-1 focus:ring-blue-500 focus:outline-none  text- text-black placeholder-gray-500 border border-gray-200 rounded-lg pl-4 py-2 mb-4"
                      placeholder="newlink.com" required />
                    <br>
                    <button class="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                      type="submit" @click="$router.push('/dashboard')">Submit</button>
  ...
  <div
    class=" h-8 lg:w-3/12 w-full bg-white focus:border-blue-600 focus:ring-1 focus:ring-blue-500 focus:outline-none m-auto text- text-black placeholder-gray-500 border border-gray-200 rounded-lg pl-4 py-2 mb-4">
  </div>
