    ...
    <div class="container">
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1">
                <form class="submit" @submit.prevent>
                  ...
                  <br>
                  <button class="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" type="submit" @click=" $router.push('/dashboard'), App.addUser(App.input.user)">Submit</button>
                  
            <div class="justify-center grid">
                    <h1 class="text-sm text-white">Don't have an account ?</h1>
                    <button @click="$router.push('/register')" class="text-sm text-blue-600 hover:text-blue-600">Register</button>
                  </div>
                </form>
